...
const CreateIncident: React.FC<CreateIncidentProps> = ({ onBack }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        try {
            // Construct incident object. ID is placeholder, backend generates it.
            await createIncident({
                ...
                status: 'Open',
                createdAt: new Date(),
                slaDeadline: new Date(Date.now() + 86400000), // Default 24h SLA
                reporter: 'Alexander' // Specific user for demo
            });
            alert("Incident successfully reported to Java Core Service!");
            onBack();
        } catch (error) {
        ...
        <div className="container mx-auto px-4 py-8 max-w-2xl animate-fade-in">
            ...
            <div className="bg-white dark:bg-dark-800 rounded-2xl shadow-lg border border-gray-200 dark:border-dark-700 p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className={`p-4 rounded-xl border transition-all duration-500 ${aiClassification
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-3">
                            <div>
                                ...
                                {isAnalysing ? (
                                    ...
                                    <div className={`mt-1 font-bold ${aiClassification?.priority === 'Critical' ? 'text-red-600' :
